  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved ingredient as @ingredient" do
        ...
        post :create, {:ingredient => { "nombre" => "invalid value" }}, valid_session
        assigns(:ingredient).should be_a_new(Ingredient)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested ingredient" do
        ...
        Ingredient.any_instance.should_receive(:update_attributes).with({ "nombre" => "MyString" })
        put :update, {:id => ingredient.to_param, :ingredient => { "nombre" => "MyString" }}, valid_session
      end
