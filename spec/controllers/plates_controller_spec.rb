...
describe PlatesController do
  ...
  describe "GET show" do
    it "assigns the requested plate as @plate" do
      plate = Plate.create! valid_attributes
      get :show, {:id => plate.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested plate as @plate" do
      plate = Plate.create! valid_attributes
      get :edit, {:id => plate.to_param}, valid_session
      assigns(:plate).should eq(plate)
    end
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested plate" do
        ...
        Plate.any_instance.should_receive(:update_attributes).with({ "nombre" => "MyString" })
        put :update, {:id => plate.to_param, :plate => { "nombre" => "MyString" }}, valid_session
      end
