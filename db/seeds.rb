...
puts 'Pacientes'
Patient.create(:nombre => "Pedro A", :rut => "17753853-4" , :num_pieza => "5A" )
Patient.create(:nombre => "Rodrigo S", :rut => "177533453-8" , :num_pieza => "5A" )
Patient.create(:nombre => "Fernando E", :rut => "13753853-3" , :num_pieza => "5A" )
Patient.create(:nombre => "Joaquin F", :rut => "16753853-2" , :num_pieza => "5A" )
